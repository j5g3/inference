...
"use strict";
	...
	JSDocParser.prototype = {
		...
		parsers: {
			...
			// @tag [text]
			parseText: 'author|deprecated|copyright|classdesc|license|requires|since|throws|todo|variation|version|see',
			
			parseMultiText: 'desc|example|summary'
		...
		parseMultiText: function(current, text)
		{
			current.text = text;
			return text.length;
		},
		...
		{
			var ln = text.indexOf("\n");
			current.text = ln===-1 ? text : text.substr(0, ln);
			return ln;
		},
